...
const FeaturedPosts = () => {
  return (
    <div className="mt-8 flex flex-col lg:flex-row gap-8 ">
      ...
      {/**other post //second half in lg screens*/}
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        {/*Second */}
        <div className="flex justify-between gap-4 lg:h-1/3">
           <Image src="featured2.jpeg" className="rounded-3xl w-1/3 aspect-video" />
           {/* details and title */}
           <div className="w-2/3">
            {/* details */}
        ...
        {/*third */}
        <div className="flex justify-between gap-4 lg:h-1/3">
        <Image src="featured3.jpeg" className="rounded-3xl w-1/3 aspect-video" />
           {/* details and title */}
           <div className="w-2/3">
            {/* details */}
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
        ...
        {/*fouth*/}
        <div className="flex justify-between gap-4 lg:h-1/3">
        <Image src="featured4.jpeg" className="rounded-3xl w-1/3 aspect-video" />
           {/* details and title */}
           <div className="w-2/3">
            {/* details */}
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
